...
from uvex_transients.models._typing import CGSParameterValue, FloatArray, FloatValue, PhysicalInput
from uvex_transients.models._util_functions import photospheric_temperature_with_floor_cgs
from uvex_transients.models._utils import ensure_in_units, to_cgs_value
...
class ArnettDecaySED(SpectralModel):
    r"""
    Radioactively-powered (Ni-56/Co-56 decay) SED, with the light curve from Arnett-style diffusion.

    This is the original Arnett (1982) formalism: a fixed mass of Ni-56 synthesized in the explosion decays
    through the chain Ni-56 -> Co-56 -> Fe-56, injecting
    ...
    def _luminosity_and_temperature_cgs(
        ...
        *,
        ...
        t : numpy.ndarray
            Time since explosion, in seconds.
        M_Ni, M_ej, v_ej, kappa, kappa_gamma, T_floor : float or numpy.ndarray
            This model's parameter values, in cgs units; see the class docstring.
