...
class PowerLawSpectrum(Spectrum):
    ...
    def _eval(  # type: ignore[override]
        ...
        *,
        ...
        log_shape = spectral_index * (np.log(safe_nu) - np.log(reference_frequency)) - np.log(reference_frequency)
...
class BrokenPowerLawSpectrum(Spectrum):
    ...
    def _eval(  # type: ignore[override]
        ...
        *,
        ...
        log_shape = alpha * (np.log(safe_nu) - np.log(break_frequency)) - np.log(break_frequency)
