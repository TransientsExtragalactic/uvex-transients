r"""Numerical helpers shared by the spectral shape models in :mod:`uvex_transients.models.spectra`."""

import numpy as np
from astropy import constants as const

from uvex_transients.models._typing import FloatArray, NumericalInput
