...
class VanVelzenTDESED(ComposedSpectralModel):
    ...
    with :math:`t_\mathrm{peak} = 5\sigma` (:class:`~uvex_transients.models.lightcurves.generic.GREDLightcurve`'s
    ...
    T^4)` factor is exactly :class:`~uvex_transients.models.spectra.thermal.BlackbodySpectrum`'s
