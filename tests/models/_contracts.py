...
consistency invariants described in :mod:`uvex_transients.models.core.base` plus
...
def _integration_bounds(model_class, cgs_params: dict) -> tuple[float, float]:
    ...
    :attr:`~uvex_transients.models.core.base.Spectrum._DOMAIN` (possibly infinite)
    otherwise.
    """
...
class ModelContract:
    ...
    :class:`~uvex_transients.models.core.base.Spectrum`, or
    :class:`~uvex_transients.models.core.base.SpectralModel` subclass.
    """
...
class LightcurveContract(ModelContract):
    """Generic checks for :class:`~uvex_transients.models.core.base.Lightcurve` subclasses."""
...
class SpectrumContract(ModelContract):
    """Generic checks for :class:`~uvex_transients.models.core.base.Spectrum` subclasses."""
...
class SpectralModelContract(ModelContract):
    """
    Generic checks for :class:`~uvex_transients.models.core.base.SpectralModel` subclasses.

    Covers both plain ``SpectralModel`` subclasses and
    :class:`~uvex_transients.models.core.base.ComposedSpectralModel` subclasses --
